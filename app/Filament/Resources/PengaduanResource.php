    ...
    ->helperText('Pilih petugas yang akan menangani aduan ini'),
            ...
            ->options([
                ...
                ->required(),
                    ...
                    // === Tambahkan field berikut untuk bukti penanganan ===
                    FileUpload::make('bukti_penanganan')
                ->label('Bukti Penanganan (Petugas)')
                ->image()
                ->disk('public')
                ->imagePreviewHeight('150')
                ->downloadable()
                ->helperText('Upload bukti penanganan jika status sudah "Ditangani"')
                ->visible(function ($get) {
                    return $get('status') === 'ditangani';
                })

    ...
    >
        <div className="flex flex-col items-center max-w-2xl mx-auto text-center">
            ...
            <p
                ...
                data-aos="fade-up"
            >
                Dokumen ini menjelaskan bagaimana kami mengelola, melindungi,
                dan menggunakan informasi pribadi Anda sesuai dengan prinsip
                perlindungan data yang berlaku. Transparansi dan keamanan adalah
                komitmen utama kami.
            </p>
            <a
                href="/privacy"
